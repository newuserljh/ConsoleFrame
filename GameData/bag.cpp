...
int bag::ifHasPoison()
{
	int a = caclGoodsNumber("绿色毒药（大量）") + caclGoodsNumber("绿色毒药（中量）") + caclGoodsNumber("绿色毒药（小量）") + caclGoodsNumber("道尊灵毒(绿)");
	int b = caclGoodsNumber("红色毒药（大量）") + caclGoodsNumber("红色毒药（中量）") + caclGoodsNumber("红色毒药（小量）") + caclGoodsNumber("道尊灵毒(红)");
	(a > 0)?(a = 2) : (a = 0);
	(b > 0)?(b = 1) : (b = 0);
	return a+b;
}